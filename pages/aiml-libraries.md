...
| Subtraction | XSUB {number} XS {number} | Returns difference of two numbers. Limited to positive integers only. Returns 0 if result would be negative. | **INPUT:** XSUB 67 XS 1 <br/> **OUTPUT:** 66 <br/> **INPUT:** XSUB 45 XS 132 <br/> **OUTPUT:** 0 |
